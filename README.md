...
|---|---|---|
| ![Log Meal](./screenshot/log-meal.png) | ![Dashboard](./screenshot/dashboard.png) | ![Journey](./screenshot/journey.png) |

| AI Coach | Food Scanner | Scan Result |
|---|---|---|
| ![AI Coach](./screenshot/ai-coach.png) | ![Food Scanner](./screenshot/food-scanner.png) | ![Scan Result](./screenshot/scan-result.png) |
